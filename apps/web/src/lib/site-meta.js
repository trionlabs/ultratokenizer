...
export const SITE_PAGES = [
  ...
  },
  {
    ...
    facts: [
      ...
      'A reviewer can request a fresh wallet-bound synthetic allocation and bounded PROVE budget from @yamanc on Telegram by sharing only a public EVM address.',
