...
| Synthetic fixture generator (`proofs/tools/generate-fixture.py`) | `npm run check:fixture-tools`                                                                                 | `native-evidence`                      | Python regression over the generated PDF bytes and signature; generates fixtures, authorizes nothing                |
