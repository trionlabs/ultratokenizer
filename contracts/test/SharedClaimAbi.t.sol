...
contract SharedClaimAbiTest {
    function testHistoricalProfileOneSerializationRemainsReadable() public pure {
    ...
    function testExactClaimFixtureMatchesSolidityRequestAndPublicValues() public pure {
        RequestHash.Request memory request = RequestHash.Request(
            1,
            "ISSUE",
            0x4444444444444444444444444444444444444444444444444444444444444444,
        ...
        bytes memory encoded =
            hex"";
        require(encoded.length == 224, "wrong public output length");
        IssuanceGate.Evidence memory evidence = abi.decode(encoded, (IssuanceGate.Evidence));
        require(
            evidence.profileVersion == 2 && evidence.requestDigest == RequestHash.digest(request),
            "guest/request mismatch"
        );
        require(
            evidence.signerFingerprint == 0x3ed19304fd699d5ba093d7005eebdb8fbc4d902dc489634c422fc3d306940503
                && evidence.sourceId == 0xa1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1,
            "source mismatch"
        );
        require(
